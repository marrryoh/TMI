	...
	$("#nicCheck").click(function(){
		...
		$.ajax({
			...
			success:function(str){
				...
				//현재 쓰고있던 닉네임 예/아니오 버튼
				else if(str=="my")
				{
					 var modinick = confirm("입력하신 닉네임 '"+user_nic+"'은(는) 현재 사용하고 계신 닉네임 입니다. \n 새로 변경 하시겠습니까?");
                     if(modinick){
                         $("#nicCheck").attr("nicCheck","N");
                         $("#user_nic").val("");
                     }
...
<div class="outer">
	<div id="memberinputArea">
		<form id="memberinput" action="member_Modify2" method="post">
			<h1>내 정보 수정하기</h1>
			<br><br>
								
			<div class="membertitle">아이디</div>
			<span class="input_area">
			<input type="text" maxlength="10" name="user_id" id="user_id" value="${list.user_id}" readonly></span>
			<br><br>
			...
			<input type="hidden" value="${list.user_pw}">
			<br><br>
			...
			<input type="text" maxlength="10" name="user_nic" id="user_nic" value="${list.user_nic}"></span>
			...
			<div class="membertitle">생년월일</div>
 			 ...
 			 <select class="input_area" id="month" name="month">
  			 ...
  			 <select class="input_area" id="day" name="day">
  		 	 ...
  		 	 <input type="hidden" value="${list.user_birth}">		
			 <br><br>
				
			<div class="membertitle">성별</div>
			 <span class="input_area">
			  <input type="text" maxlength="2" name="user_gender" id="user_gender" value="${list.sb}" readonly></span>
			   <br><br>
			...
			<div class="membertitle">주소</div>
			 ...
			 <input type="hidden" value="${list.user_address}">
			 
			<div class="btnArea">
	 			<button id="memberCheck">수정하기</button> <button id="delchk">탈퇴하기</button>
			</div>
